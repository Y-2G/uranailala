  ...
  const plans = [
    {
      ...
      features: ["占術1つを選択", "基本的な鑑定", "アドバイスシート"],
      recommended: false,
    },
    {
      name: "スタンダード",
      ...
      <div className={styles.pricingContainer}>
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className={styles.pricingCardHeader}>
                ...
                <div className={styles.pricingDuration}>{plan.duration}</div>
              </div>
        ...
        <div className={styles.pricingNotes}>
            ...
            <div className={styles.pricingNoteAlertRow}>
              ...
              <div>
                ...
                <ul className={styles.pricingNoteAlertList}>
                  <li>
                    • 出張鑑定の場合：交通費を別途ご負担いただきます（実費）
                  </li>
                  <li>• 延長をご希望の場合：10分ごとに¥1,000</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className={styles.pricingNoteNeutral}>
            <h4 className={styles.pricingNoteNeutralTitle}>お支払い方法</h4>
