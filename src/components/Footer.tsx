    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerBrand}>
            ...
            <p className={styles.footerBrandDesc}>
              毎日を楽しく過ごすための小さなエッセンス
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className={styles.footerSectionTitle}>ページリンク</h3>
          ...
          {/* Social & Legal */}
          <div>
            <h3 className={styles.footerSectionTitle}>SNSリンク</h3>
        ...
        <div className={styles.footerCopyright}>
          <p>
            &copy; {currentYear} ヒント出しヒーラー らら. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
